...
public class App {
        ...
        while (isOpcaoValida(opcao)) {
            ...
            if (isOpcaoSair(opcao)) {
                ...
                String dados = JOptionPane.showInputDialog(null,
                        "Digite os dados do cliente separados por vígula ',' conforme " +
    ...
    private static void consultar(String dados) {
        ...
        if (cliente != null) {
            JOptionPane.showMessageDialog(null,
                    "Cliente encontrado com sucesso! " + cliente.toString(), "Sucesso",JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    private static void sair() {
        ...
        JOptionPane.showMessageDialog(null,
                "Clientes cadastrados!" + clientesCadastrados, "Sair",
                JOptionPane.INFORMATION_MESSAGE);
        System.exit(0);
    }
