...
import br.com.gabri.vendas.online.reources.ClienteResource;
import br.com.gabri.vendas.online.usecase.BuscaCliente;
import br.com.gabri.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("Gabriel 1").build();
